...
import Foundation
struct ChartsItems: MockResponseCodable {
    var chartType: String?
    var description: String?
    var items: [ChartsItemDetail]?
    var title: String?
    ...
    init(from decoder: Decoder) throws {
        ...
        items = try values.decodeIfPresent([ChartsItemDetail].self, forKey: .items)
